...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top"  style="box-shadow: 0 8px 8px 0 rgba(0,0,0,.2);">
      <div class="container">
        <div class="navbar-header">
          <a href="#" class="navbar-brand"><b><i>SISTEM INFORMASI TES KEPRIBADIAN</i></b></a>
  ...
  <!-- Full Width Column -->
  <div class="content-wrapper"  style="background-image: url('/logo/bg1.jpg'); background-size:cover">
    <div class="container">
          ...
          <br/><br/>
            <div class="box box-danger">
              <div class="box-header with-border text-center">
                <h3 class="box-title">TES KEPRIBADIAN METODE CBR - ADMIN</h3>
              ...
              <div class="box-footer social-auth-links">
                <button type="submit" class="btn btn-danger btn-flat btn-block" style="border-radius: 75px"><i class="fa fa-sign-out"></i> Masuk</button>
              </div>
              </form>
            </div>
          </div>
